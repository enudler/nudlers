...
const meta = {
    ...
    args: {
        ...
        onMarkNotRecurring: (name) => console.log('Mark not recurring:', name),
        onAddRecurring: () => console.log('Add recurring triggered'),
        setSelectedAccount: (val) => console.log('Select account:', val),
        setIsAddDialogOpen: (open) => console.log('Set dialog open:', open),
        setNewRecurring: () => console.log('Set new recurring'),
        setSnackbar: () => console.log('Set snackbar'),
    },
