...
const ProjectionView: React.FC = () => {
    ...
    return (
        <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: '1600px', margin: '0 auto', height: '100vh', display: 'flex', flexDirection: 'column' }}>
            <PageHeader
            ...
            <Box sx={{ display: 'flex', gap: 4, flexGrow: 1, minHeight: 0, mt: -2 }}>
                                                ...
                                                <Box key={`br-${i}`} sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                    ...
                                                    <MuiTooltip title="Stop projecting this recurring item">
                                                        <IconButton
                                                            ...
                                                            onClick={(e) => { e.stopPropagation(); handleMarkNotRecurring(br.name, br.account_number); }}
                                                        >
            ...
            <Dialog
                ...
                PaperProps={{
                    className: 'n-glass',
                    sx: { borderRadius: '24px', minWidth: '400px' }
                }}
            >
